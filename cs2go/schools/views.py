...
#This route is to create a new post for the "Module Post Board", This was called "Module Chat" hence the use of the name "Chat", didnt have time to change the naming of everything
