...
4) Open browser and enter http://127.0.0.1:8080/  

5) Done

Quick explaination of the file structure of the project: 
...
The files that are uploaded to cs2go are stored in the uploads folder.
